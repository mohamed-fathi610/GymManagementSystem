        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Adress_BuildingNumber = table.Column<int>(type: "int", nullable: false),
                    Adress_City = table.Column<string>(type: "varchar(30)", nullable: false),
                    Adress_Street = table.Column<string>(type: "varchar(30)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Members", x => x.Id);
                    table.CheckConstraint("CK_Email", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("Egyption_CK_Phone", "Phone LIKE '01[0125]%' and Phone not LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Email1", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("Egyption_CK_Phone1", "Phone LIKE '01[0125]%' and Phone not LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Capacity", "Capacity between 1 and 25");
                    table.CheckConstraint("CK_EndDate", "EndDate > StartDate");
                    table.ForeignKey(
